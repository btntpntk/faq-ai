...
## ค่าใช้จ่ายโดยประมาณ (ต่อ 1 call)

| บริการ | ราคา |
|---|---|
| Azure STT (~5 วินาที) | ~$0.0014 |
| Azure TTS (~150 ตัวอักษร) | ~$0.0024 |
| Gemini 2.5 Flash (~3,000 input / 150 output tokens) | ~$0.00054 |
| **รวม** | **~$0.004 / call** |
...
> TTS คิดตามจำนวนตัวอักษรของคำตอบ — คำตอบยาวมีต้นทุนสูงขึ้น
